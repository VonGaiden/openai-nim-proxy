...
// Environment variable check AFTER requires
...
const MODEL_MAPPING = {
  ...
  'gpt-4-turbo': 'mistralai/mistral-small-4-119b-2603',
...
// ── Helper functions (defined OUTSIDE route handlers) ──────────────────────
...
app.post('/v1/chat/completions', async (req, res) => {
  try {
    ...
    console.error('NVIDIA error response:', JSON.stringify(error.response?.data, null, 2));
